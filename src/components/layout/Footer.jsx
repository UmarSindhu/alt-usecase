...
import { Github, Twitter, Linkedin, Info, Lightbulb, Zap, Blocks } from 'lucide-react';
    ...
    <footer className="bg-background/50 border-t border-border/40">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-2 gradient-text">AltUseCase</h3>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><Link to="/category" className="text-muted-foreground hover:text-primary transition-colors flex items-center"><Blocks size={16} className="mr-2" />Categories</Link></li>
          ...
          <div>
            <h4 className="font-semibold mb-2">Our Social Networks</h4>
        ...
        <div className="text-center text-sm text-muted-foreground">
          &copy; {currentYear} AltUseCase. All rights reserved. Built By <strong><a href="https://sindhusolutions.com" className="gradient-text" target="_blank">Sindhu Solutions</a></strong>
        </div>
      </div>
    </footer>
  );
